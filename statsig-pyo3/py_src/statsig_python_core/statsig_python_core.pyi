...
class StatsigBasePy:
    ...
    def _INTERNAL_get_experiment_as_dict(self, user: StatsigUser, name: builtins.str, options: typing.Optional[ExperimentEvaluationOptions] = None) -> dict: ...
    ...
    def _INTERNAL_get_layer_exposure_raw_and_dict(self, user: StatsigUser, name: builtins.str, options: typing.Optional[LayerEvaluationOptions] = None) -> tuple[builtins.str, dict]: ...
