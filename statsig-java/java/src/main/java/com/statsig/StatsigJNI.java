...
class StatsigJNI {
  ...
  /** Statsig */
  public static native String statsigCreate(
      String sdkKey, String optionsRef, String statsigMetadata);
  ...
  public static native String statsigInitializeWithDetails(String statsigRef);
  ...
  public static native boolean statsigCheckGate(
      String statsigRef, String userRef, String gateName, CheckGateOptions options);
  ...
  public static native void statsigLogGateExposure(
      String statsigRef, String userRef, String gateName);

  public static native String statsigGetLayer(
      String statsigRef, String userRef, String layerName, GetLayerOptions options);

  public static native void statsigManuallyLogLayerParamExposure(
      String statsigRef, String userRef, String layerName, String param);
  ...
  public static native String statsigGetExperiment(
      String statsigRef, String userRef, String experimentName, GetExperimentOptions options);

  public static native void statsigLogExperimentExposure(
      String statsigRef, String userRef, String experimentName);

  public static native String statsigGetFieldsNeededForExperiment(
      String statsigRef, String experimentName);

  public static native String statsigGetDynamicConfig(
      String statsigRef, String userRef, String configName, GetDynamicConfigOptions options);

  public static native void statsigLogDynamicConfigExposure(
      String statsigRef, String userRef, String configName);

  public static native String statsigGetFieldsNeededForDynamicConfig(
      String statsigRef, String configName);

  public static native String statsigGetCMABRankedVariants(
      String statsigRef, String userRef, String cmabName);

  public static native void statsigLogCMABExposure(
      String statsigRef, String userRef, String cmabName, String ruleId);

  public static native String statsigGetClientInitResponse(
      String statsigRef, String userRef, ClientInitResponseOptions options);
  ...
  public static native void statsigLogLayerParamExposure(
      String statsigRef, String layerJson, String param);

  public static native String statsigGetParameterStore(
      String statsigRef, String parameterStoreName);
  ...
  public static native void statsigOverrideGate(
      String statsigRef, String gateName, String id, boolean overrideVal);

  public static native void statsigOverrideDynamicConfig(
      String statsigRef, String configName, String id, Map<String, Object> overrideVal);

  public static native void statsigOverrideLayer(
      String statsigRef, String layerName, String id, Map<String, Object> overrideVal);

  public static native void statsigOverrideExperiment(
      String statsigRef, String experimentName, String id, Map<String, Object> overrideVal);

  public static native void statsigOverrideExperimentByGroupName(
      String statsigRef, String experimentName, String id, String groupName);

  /** Remove Overrides */
  public static native void statsigRemoveGateOverride(
      String statsigRef, String gateName, String id);

  public static native void statsigRemoveDynamicConfigOverride(
      String statsigRef, String configName, String id);

  public static native void statsigRemoveExperimentOverride(
      String statsigRef, String experimentName, String id);

  public static native void statsigRemoveLayerOverride(
      String statsigRef, String layerName, String id);
    ...
    try {
      ...
      if (resource == null) {
        OutputLogger.logError(
            TAG, "Unable to find native library resource for OS: " + osName + " Arch: " + osArch);
        return false;
      }
