...
class StatsigJNI {
    ...
    static {
        OutputLogger.logInfo(TAG, "Detected OS: " + NativeBinaryResolver.osName + " Arch: " + NativeBinaryResolver.normalizedArch);
        ...
        try {
            ...
            if (resource == null) {
                OutputLogger.logError(
                        TAG,
                        "Unable to find native library resource for OS: " + osName + " Arch: " + arch);
                return false;
            }
