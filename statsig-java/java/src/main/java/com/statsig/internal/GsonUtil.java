...
public class GsonUtil {
    ...
    public static Gson getGson() {
     ...
     static class MapDeserializer implements JsonDeserializer<Map<String, JsonElement>> {
         ...
         @Override
         public Map<String, JsonElement> deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context) {
    ...
    public static boolean getBoolean(Map<String, JsonElement> value, String key, boolean defaultValue) {
        JsonElement res = value.get(key);
    ...
    public static Object[] getArray(Map<String, JsonElement> value, String key, Object[] defaultValue) {
        JsonElement res = value.get(key);
    ...
    public static Map<String, Object> getMap(Map<String, JsonElement> value, String key, Map<String, Object> defaultValue) {
        JsonElement res = value.get(key);
