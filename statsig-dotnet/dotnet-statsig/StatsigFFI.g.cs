...
namespace Statsig
{
    internal static unsafe partial class StatsigFFI
    {
        ...
        internal static extern byte* statsig_options_create(byte* specs_url, byte* log_event_url, byte* specs_adapter_ref, byte* event_logging_adapter_ref, byte* environment, int event_logging_flush_interval_ms, int event_logging_max_queue_size, int specs_sync_interval_ms, byte* output_log_level);
