...
pub mod curl_service_tests {
    use crate::utils::mock_scrapi::{Endpoint, EndpointStub, MockScrapi};
    use statsig_rust::networking::providers::net_provider_curl::NetworkProviderCurl;
    ...
    async fn test_multiple_requests() {
        ...
        for _ in 0..3 {
            let curl_clone = NetworkProviderCurl::get_instance("multiple_requests_key");
