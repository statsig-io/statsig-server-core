...
const EVAL_PROJ_CHECKSUM: &str = "8506699639233708000" /* eval_proj_dcs.json['checksum'] */;
...
const DEMO_PROJ_CHECKSUM: &str = "6221227889497997000" /* demo_proj_dcs.json['checksum'] */;
const DEMO_PROJ_GATE_COUNT: usize = 9 /* demo_proj_dcs.json['feature_gates'].length */;
const DEMO_PROJ_DC_COUNT: usize = 8 /* demo_proj_dcs.json['dynamic_configs'].length */;
