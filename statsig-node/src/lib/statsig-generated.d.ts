...
export declare class StatsigNapiInternal {
  ...
  constructor(
    networkFunc: unknown,
    sdkKey: string,
    options?: StatsigOptions | undefined | null
  );
  ...
  getParameterStore(
    ...
    options?: ParameterStoreEvaluationOptions | undefined | null
  ): ParameterStore;
  ...
  getParsedUserAgentValueForUser(
    user: StatsigUser
  ): Record<string, string | undefined | null> | null;
}
...
export declare class StatsigUser {
  ...
  set statsigEnvironment(
    value:
      | { tier?: string; [key: string]: string | undefined }
      | null
      | undefined
  );
...
export declare function __internal__testDataStore(
  store: DataStore,
  path: string,
  value: string
): Promise<[DataStoreResponse | undefined | null, boolean]>;

export declare function __internal__testObservabilityClient(
...
export declare function __internal__testOutputLogger(
...
export declare function __internal__testPersistentStorage(
...
export declare function statsigCaptureLogLine(
  level: string,
